    ...
    <div class="card">
        ...
        <form action="{{route('update.slider')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" id="example-text-input" name="video_url" value="{{$homeSlide->video_url}}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" src="{{(!empty($homeSlide->home_slide))? url('upload/home_slider/'.$homeSlide->home_slide):url('upload/no_image.jpg')}}" class="rounded avatar-lg" alt="...">
                </div>
            </div>
