    ...
    <div class="card">
        ...
        <form action="{{route('update.about')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea id="textarea" class="form-control" maxlength="225" rows="3" name="short_description">{{$aboutData->short_description}}</textarea>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" src="{{(!empty($aboutData->about_image))? url('upload/home_slider/'.$aboutData->about_image):url('upload/no_image.jpg')}}" class="rounded avatar-lg" alt="...">
                </div>
            </div>

            <input type="submit" value="A About Page" class="btn btn-info waves-effect waves-light">
        </form>      
    </div>
</div>
</div>
